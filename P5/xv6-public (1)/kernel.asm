...
80103046:	e8 c5 3a 00 00       	call   80106b10 <switchkvm>
  seginit();
8010304b:	e8 b0 38 00 00       	call   80106900 <seginit>
  lapicinit();
...
80103090:	e8 6b 38 00 00       	call   80106900 <seginit>
  picinit();       // disable pic
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 ff 58 10 80 	movl   $0x801058ff,0x14(%eax)
  p->context = (struct context*)sp;
...
80103e9d:	68 e8 7b 10 80       	push   $0x80107be8
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 db 7b 10 80       	push   $0x80107bdb
...
80103fe0:	68 f4 7b 10 80       	push   $0x80107bf4
...
801040e9:	68 fa 7b 10 80       	push   $0x80107bfa
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 f4 7b 10 80       	push   $0x80107bf4
...
801041fb:	68 7f 7f 10 80       	push   $0x80107f7f
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 0b 7c 10 80       	mov    $0x80107c0b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 6c 7c 10 80 	mov    -0x7fef8394(,%eax,4),%edx
      state = "???";
8010422f:	b8 0b 7c 10 80       	mov    $0x80107c0b,%eax
...
8010423e:	68 0f 7c 10 80       	push   $0x80107c0f
...
8010427d:	68 61 76 10 80       	push   $0x80107661
...
801042aa:	68 84 7c 10 80       	push   $0x80107c84
...
801044e5:	68 8f 7c 10 80       	push   $0x80107c8f
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 a6 7c 10 80       	push   $0x80107ca6
...
8010455b:	68 ad 7c 10 80       	push   $0x80107cad
...
80104650:	68 b5 7c 10 80       	push   $0x80107cb5
...
80104a7c:	8b 14 85 e0 7c 10 80 	mov    -0x7fef8320(,%eax,4),%edx
...
80104aa8:	68 bd 7c 10 80       	push   $0x80107cbd
...
80104c04:	68 5c 7d 10 80       	push   $0x80107d5c
...
80104c1c:	68 5b 7d 10 80       	push   $0x80107d5b
...
80104c31:	68 4f 7d 10 80       	push   $0x80107d4f
...
80104c4f:	68 5e 7d 10 80       	push   $0x80107d5e
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 40 7d 10 80       	push   $0x80107d40
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 5c 7d 10 80       	push   $0x80107d5c
...
80105078:	68 5b 7d 10 80       	push   $0x80107d5b
...
int sys_mmap(void) {
80105846:	83 ec 24             	sub    $0x24,%esp
    if (argint(i, &args[i]) < 0) {
80105849:	83 ec 08             	sub    $0x8,%esp
8010584c:	8d 44 9d e0          	lea    -0x20(%ebp,%ebx,4),%eax
80105850:	50                   	push   %eax
80105851:	53                   	push   %ebx
80105852:	e8 c9 f0 ff ff       	call   80104920 <argint>
80105857:	83 c4 10             	add    $0x10,%esp
8010585a:	85 c0                	test   %eax,%eax
8010585c:	78 32                	js     80105890 <sys_mmap+0x50>
  for (int i = 0; i < 6; i++) {
8010585e:	83 c3 01             	add    $0x1,%ebx
80105861:	83 fb 06             	cmp    $0x6,%ebx
80105864:	75 e3                	jne    80105849 <sys_mmap+0x9>
...
8010586f:	ff 75 ec             	push   -0x14(%ebp)
80105872:	ff 75 e8             	push   -0x18(%ebp)
80105875:	ff 75 e4             	push   -0x1c(%ebp)
80105878:	ff 75 e0             	push   -0x20(%ebp)
8010587b:	e8 a0 1b 00 00       	call   80107420 <mmap>

  // If mmap failed, return -1
  if (ret == MMAP_FAILED) {
80105880:	83 c4 20             	add    $0x20,%esp
80105883:	83 f8 ff             	cmp    $0xffffffff,%eax
80105886:	74 08                	je     80105890 <sys_mmap+0x50>
    return -1;
  }
...
801058d6:	e8 a5 1c 00 00       	call   80107580 <munmap>
...
80105927:	c7 04 c5 c2 4c 11 80 	movl   $0x8e000008,-0x7feeb33e(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 c0 4c 11 	mov    %dx,-0x7feeb340(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 c6 4c 11 	mov    %dx,-0x7feeb33a(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
8010594f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105952:	a1 08 b1 10 80       	mov    0x8010b108,%eax
80105957:	c7 05 c2 4e 11 80 08 	movl   $0xef000008,0x80114ec2
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 a1 7d 10 80       	push   $0x80107da1
80105966:	68 80 4c 11 80       	push   $0x80114c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 c0 4e 11 80    	mov    %ax,0x80114ec0
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 c6 4e 11 80    	mov    %ax,0x80114ec6
  initlock(&tickslock, "time");
...
8010599b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010599f:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
801059e4:	ff 24 85 48 7e 10 80 	jmp    *-0x7fef81b8(,%eax,4)
...
80105ac5:	68 04 7e 10 80       	push   $0x80107e04
...
80105b17:	68 ac 7d 10 80       	push   $0x80107dac
...
80105bd0:	68 80 4c 11 80       	push   $0x80114c80
80105bd5:	e8 c6 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105bda:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
      ticks++;
80105be1:	83 05 60 4c 11 80 01 	addl   $0x1,0x80114c60
      wakeup(&ticks);
80105be8:	e8 13 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105bed:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
80105c33:	68 d0 7d 10 80       	push   $0x80107dd0
80105c38:	e8 63 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c3d:	83 c4 14             	add    $0x14,%esp
80105c40:	68 a6 7d 10 80       	push   $0x80107da6
...
{
  if(!uart)
80105c50:	a1 c0 54 11 80       	mov    0x801154c0,%eax
...
80105cd7:	74 78                	je     80105d51 <uartinit+0xd1>
  uart = 1;
80105cd9:	c7 05 c0 54 11 80 01 	movl   $0x1,0x801154c0
80105ce0:	00 00 00 
...
80105cec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cef:	bf c8 7e 10 80       	mov    $0x80107ec8,%edi
...
80105d09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105d10:	a1 c0 54 11 80       	mov    0x801154c0,%eax
...
80105dd7:	6a 00                	push   $0x0
  jmp alltraps
80105dd9:	e9 09 fb ff ff       	jmp    801058e7 <alltraps>
...
80105de0:	6a 01                	push   $0x1
  jmp alltraps
80105de2:	e9 00 fb ff ff       	jmp    801058e7 <alltraps>
...
80105de9:	6a 02                	push   $0x2
  jmp alltraps
80105deb:	e9 f7 fa ff ff       	jmp    801058e7 <alltraps>
...
80105df2:	6a 03                	push   $0x3
  jmp alltraps
80105df4:	e9 ee fa ff ff       	jmp    801058e7 <alltraps>
...
80105dfb:	6a 04                	push   $0x4
  jmp alltraps
80105dfd:	e9 e5 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e04:	6a 05                	push   $0x5
  jmp alltraps
80105e06:	e9 dc fa ff ff       	jmp    801058e7 <alltraps>
...
80105e2d:	6a 0a                	push   $0xa
  jmp alltraps
80105e2f:	e9 b3 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e34:	6a 0b                	push   $0xb
  jmp alltraps
80105e36:	e9 ac fa ff ff       	jmp    801058e7 <alltraps>
...
80105e3b:	6a 0c                	push   $0xc
  jmp alltraps
80105e3d:	e9 a5 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e49:	6a 0e                	push   $0xe
  jmp alltraps
80105e4b:	e9 97 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e62:	6a 11                	push   $0x11
  jmp alltraps
80105e64:	e9 7e fa ff ff       	jmp    801058e7 <alltraps>
...
80105e6b:	6a 12                	push   $0x12
  jmp alltraps
80105e6d:	e9 75 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e74:	6a 13                	push   $0x13
  jmp alltraps
80105e76:	e9 6c fa ff ff       	jmp    801058e7 <alltraps>
...
80105e7d:	6a 14                	push   $0x14
  jmp alltraps
80105e7f:	e9 63 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e86:	6a 15                	push   $0x15
  jmp alltraps
80105e88:	e9 5a fa ff ff       	jmp    801058e7 <alltraps>
...
80105e8f:	6a 16                	push   $0x16
  jmp alltraps
80105e91:	e9 51 fa ff ff       	jmp    801058e7 <alltraps>
...
80105e98:	6a 17                	push   $0x17
  jmp alltraps
80105e9a:	e9 48 fa ff ff       	jmp    801058e7 <alltraps>
...
80105ea1:	6a 18                	push   $0x18
  jmp alltraps
80105ea3:	e9 3f fa ff ff       	jmp    801058e7 <alltraps>
...
80105eaa:	6a 19                	push   $0x19
  jmp alltraps
80105eac:	e9 36 fa ff ff       	jmp    801058e7 <alltraps>
...
80105eb3:	6a 1a                	push   $0x1a
  jmp alltraps
80105eb5:	e9 2d fa ff ff       	jmp    801058e7 <alltraps>
...
80105ebc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ebe:	e9 24 fa ff ff       	jmp    801058e7 <alltraps>
...
80105ec5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ec7:	e9 1b fa ff ff       	jmp    801058e7 <alltraps>
...
80105ece:	6a 1d                	push   $0x1d
  jmp alltraps
80105ed0:	e9 12 fa ff ff       	jmp    801058e7 <alltraps>
...
80105ed7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ed9:	e9 09 fa ff ff       	jmp    801058e7 <alltraps>
...
80105ee0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ee2:	e9 00 fa ff ff       	jmp    801058e7 <alltraps>
...
80105ee9:	6a 20                	push   $0x20
  jmp alltraps
80105eeb:	e9 f7 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105ef2:	6a 21                	push   $0x21
  jmp alltraps
80105ef4:	e9 ee f9 ff ff       	jmp    801058e7 <alltraps>
...
80105efb:	6a 22                	push   $0x22
  jmp alltraps
80105efd:	e9 e5 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f04:	6a 23                	push   $0x23
  jmp alltraps
80105f06:	e9 dc f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f0d:	6a 24                	push   $0x24
  jmp alltraps
80105f0f:	e9 d3 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f16:	6a 25                	push   $0x25
  jmp alltraps
80105f18:	e9 ca f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f1f:	6a 26                	push   $0x26
  jmp alltraps
80105f21:	e9 c1 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f28:	6a 27                	push   $0x27
  jmp alltraps
80105f2a:	e9 b8 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f31:	6a 28                	push   $0x28
  jmp alltraps
80105f33:	e9 af f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f3a:	6a 29                	push   $0x29
  jmp alltraps
80105f3c:	e9 a6 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f43:	6a 2a                	push   $0x2a
  jmp alltraps
80105f45:	e9 9d f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f4c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f4e:	e9 94 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f55:	6a 2c                	push   $0x2c
  jmp alltraps
80105f57:	e9 8b f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f5e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f60:	e9 82 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f67:	6a 2e                	push   $0x2e
  jmp alltraps
80105f69:	e9 79 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f70:	6a 2f                	push   $0x2f
  jmp alltraps
80105f72:	e9 70 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f79:	6a 30                	push   $0x30
  jmp alltraps
80105f7b:	e9 67 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f82:	6a 31                	push   $0x31
  jmp alltraps
80105f84:	e9 5e f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f8b:	6a 32                	push   $0x32
  jmp alltraps
80105f8d:	e9 55 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f94:	6a 33                	push   $0x33
  jmp alltraps
80105f96:	e9 4c f9 ff ff       	jmp    801058e7 <alltraps>
...
80105f9d:	6a 34                	push   $0x34
  jmp alltraps
80105f9f:	e9 43 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fa6:	6a 35                	push   $0x35
  jmp alltraps
80105fa8:	e9 3a f9 ff ff       	jmp    801058e7 <alltraps>
...
80105faf:	6a 36                	push   $0x36
  jmp alltraps
80105fb1:	e9 31 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fb8:	6a 37                	push   $0x37
  jmp alltraps
80105fba:	e9 28 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fc1:	6a 38                	push   $0x38
  jmp alltraps
80105fc3:	e9 1f f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fca:	6a 39                	push   $0x39
  jmp alltraps
80105fcc:	e9 16 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fd3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fd5:	e9 0d f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fdc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fde:	e9 04 f9 ff ff       	jmp    801058e7 <alltraps>
...
80105fe5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fe7:	e9 fb f8 ff ff       	jmp    801058e7 <alltraps>
...
80105fee:	6a 3d                	push   $0x3d
  jmp alltraps
80105ff0:	e9 f2 f8 ff ff       	jmp    801058e7 <alltraps>
...
80105ff7:	6a 3e                	push   $0x3e
  jmp alltraps
80105ff9:	e9 e9 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106000:	6a 3f                	push   $0x3f
  jmp alltraps
80106002:	e9 e0 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106009:	6a 40                	push   $0x40
  jmp alltraps
8010600b:	e9 d7 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106012:	6a 41                	push   $0x41
  jmp alltraps
80106014:	e9 ce f8 ff ff       	jmp    801058e7 <alltraps>
...
8010601b:	6a 42                	push   $0x42
  jmp alltraps
8010601d:	e9 c5 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106024:	6a 43                	push   $0x43
  jmp alltraps
80106026:	e9 bc f8 ff ff       	jmp    801058e7 <alltraps>
...
8010602d:	6a 44                	push   $0x44
  jmp alltraps
8010602f:	e9 b3 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106036:	6a 45                	push   $0x45
  jmp alltraps
80106038:	e9 aa f8 ff ff       	jmp    801058e7 <alltraps>
...
8010603f:	6a 46                	push   $0x46
  jmp alltraps
80106041:	e9 a1 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106048:	6a 47                	push   $0x47
  jmp alltraps
8010604a:	e9 98 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106051:	6a 48                	push   $0x48
  jmp alltraps
80106053:	e9 8f f8 ff ff       	jmp    801058e7 <alltraps>
...
8010605a:	6a 49                	push   $0x49
  jmp alltraps
8010605c:	e9 86 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106063:	6a 4a                	push   $0x4a
  jmp alltraps
80106065:	e9 7d f8 ff ff       	jmp    801058e7 <alltraps>
...
8010606c:	6a 4b                	push   $0x4b
  jmp alltraps
8010606e:	e9 74 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106075:	6a 4c                	push   $0x4c
  jmp alltraps
80106077:	e9 6b f8 ff ff       	jmp    801058e7 <alltraps>
...
8010607e:	6a 4d                	push   $0x4d
  jmp alltraps
80106080:	e9 62 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106087:	6a 4e                	push   $0x4e
  jmp alltraps
80106089:	e9 59 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106090:	6a 4f                	push   $0x4f
  jmp alltraps
80106092:	e9 50 f8 ff ff       	jmp    801058e7 <alltraps>
...
80106099:	6a 50                	push   $0x50
  jmp alltraps
8010609b:	e9 47 f8 ff ff       	jmp    801058e7 <alltraps>
...
801060a2:	6a 51                	push   $0x51
  jmp alltraps
801060a4:	e9 3e f8 ff ff       	jmp    801058e7 <alltraps>
...
801060ab:	6a 52                	push   $0x52
  jmp alltraps
801060ad:	e9 35 f8 ff ff       	jmp    801058e7 <alltraps>
...
801060b4:	6a 53                	push   $0x53
  jmp alltraps
801060b6:	e9 2c f8 ff ff       	jmp    801058e7 <alltraps>
...
801060bd:	6a 54                	push   $0x54
  jmp alltraps
801060bf:	e9 23 f8 ff ff       	jmp    801058e7 <alltraps>
...
801060c6:	6a 55                	push   $0x55
  jmp alltraps
801060c8:	e9 1a f8 ff ff       	jmp    801058e7 <alltraps>
...
801060cf:	6a 56                	push   $0x56
  jmp alltraps
801060d1:	e9 11 f8 ff ff       	jmp    801058e7 <alltraps>
...
801060d8:	6a 57                	push   $0x57
  jmp alltraps
801060da:	e9 08 f8 ff ff       	jmp    801058e7 <alltraps>
...
801060e1:	6a 58                	push   $0x58
  jmp alltraps
801060e3:	e9 ff f7 ff ff       	jmp    801058e7 <alltraps>
...
801060ea:	6a 59                	push   $0x59
  jmp alltraps
801060ec:	e9 f6 f7 ff ff       	jmp    801058e7 <alltraps>
...
801060f3:	6a 5a                	push   $0x5a
  jmp alltraps
801060f5:	e9 ed f7 ff ff       	jmp    801058e7 <alltraps>
...
801060fc:	6a 5b                	push   $0x5b
  jmp alltraps
801060fe:	e9 e4 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106105:	6a 5c                	push   $0x5c
  jmp alltraps
80106107:	e9 db f7 ff ff       	jmp    801058e7 <alltraps>
...
8010610e:	6a 5d                	push   $0x5d
  jmp alltraps
80106110:	e9 d2 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106117:	6a 5e                	push   $0x5e
  jmp alltraps
80106119:	e9 c9 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106120:	6a 5f                	push   $0x5f
  jmp alltraps
80106122:	e9 c0 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106129:	6a 60                	push   $0x60
  jmp alltraps
8010612b:	e9 b7 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106132:	6a 61                	push   $0x61
  jmp alltraps
80106134:	e9 ae f7 ff ff       	jmp    801058e7 <alltraps>
...
8010613b:	6a 62                	push   $0x62
  jmp alltraps
8010613d:	e9 a5 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106144:	6a 63                	push   $0x63
  jmp alltraps
80106146:	e9 9c f7 ff ff       	jmp    801058e7 <alltraps>
...
8010614d:	6a 64                	push   $0x64
  jmp alltraps
8010614f:	e9 93 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106156:	6a 65                	push   $0x65
  jmp alltraps
80106158:	e9 8a f7 ff ff       	jmp    801058e7 <alltraps>
...
8010615f:	6a 66                	push   $0x66
  jmp alltraps
80106161:	e9 81 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106168:	6a 67                	push   $0x67
  jmp alltraps
8010616a:	e9 78 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106171:	6a 68                	push   $0x68
  jmp alltraps
80106173:	e9 6f f7 ff ff       	jmp    801058e7 <alltraps>
...
8010617a:	6a 69                	push   $0x69
  jmp alltraps
8010617c:	e9 66 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106183:	6a 6a                	push   $0x6a
  jmp alltraps
80106185:	e9 5d f7 ff ff       	jmp    801058e7 <alltraps>
...
8010618c:	6a 6b                	push   $0x6b
  jmp alltraps
8010618e:	e9 54 f7 ff ff       	jmp    801058e7 <alltraps>
...
80106195:	6a 6c                	push   $0x6c
  jmp alltraps
80106197:	e9 4b f7 ff ff       	jmp    801058e7 <alltraps>
...
8010619e:	6a 6d                	push   $0x6d
  jmp alltraps
801061a0:	e9 42 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061a7:	6a 6e                	push   $0x6e
  jmp alltraps
801061a9:	e9 39 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061b0:	6a 6f                	push   $0x6f
  jmp alltraps
801061b2:	e9 30 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061b9:	6a 70                	push   $0x70
  jmp alltraps
801061bb:	e9 27 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061c2:	6a 71                	push   $0x71
  jmp alltraps
801061c4:	e9 1e f7 ff ff       	jmp    801058e7 <alltraps>
...
801061cb:	6a 72                	push   $0x72
  jmp alltraps
801061cd:	e9 15 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061d4:	6a 73                	push   $0x73
  jmp alltraps
801061d6:	e9 0c f7 ff ff       	jmp    801058e7 <alltraps>
...
801061dd:	6a 74                	push   $0x74
  jmp alltraps
801061df:	e9 03 f7 ff ff       	jmp    801058e7 <alltraps>
...
801061e6:	6a 75                	push   $0x75
  jmp alltraps
801061e8:	e9 fa f6 ff ff       	jmp    801058e7 <alltraps>
...
801061ef:	6a 76                	push   $0x76
  jmp alltraps
801061f1:	e9 f1 f6 ff ff       	jmp    801058e7 <alltraps>
...
801061f8:	6a 77                	push   $0x77
  jmp alltraps
801061fa:	e9 e8 f6 ff ff       	jmp    801058e7 <alltraps>
...
80106201:	6a 78                	push   $0x78
  jmp alltraps
80106203:	e9 df f6 ff ff       	jmp    801058e7 <alltraps>
...
8010620a:	6a 79                	push   $0x79
  jmp alltraps
8010620c:	e9 d6 f6 ff ff       	jmp    801058e7 <alltraps>
...
80106213:	6a 7a                	push   $0x7a
  jmp alltraps
80106215:	e9 cd f6 ff ff       	jmp    801058e7 <alltraps>
...
80106225:	6a 7c                	push   $0x7c
  jmp alltraps
80106227:	e9 bb f6 ff ff       	jmp    801058e7 <alltraps>
...
8010622e:	6a 7d                	push   $0x7d
  jmp alltraps
80106230:	e9 b2 f6 ff ff       	jmp    801058e7 <alltraps>
...
80106237:	6a 7e                	push   $0x7e
  jmp alltraps
80106239:	e9 a9 f6 ff ff       	jmp    801058e7 <alltraps>
...
8010680d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106812:	e9 d0 f0 ff ff       	jmp    801058e7 <alltraps>
...
80106819:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010681e:	e9 c4 f0 ff ff       	jmp    801058e7 <alltraps>
...
80106825:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010682a:	e9 b8 f0 ff ff       	jmp    801058e7 <alltraps>
...
80106831:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106836:	e9 ac f0 ff ff       	jmp    801058e7 <alltraps>
...
8010683d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106842:	e9 a0 f0 ff ff       	jmp    801058e7 <alltraps>
...
801068ef:	68 86 78 10 80       	push   $0x80107886
...
80106903:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106906:	e8 45 d0 ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
8010690b:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106910:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106916:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X | STA_R, 0, 0xffffffff, 0);
8010691a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106921:	ff 00 00 
80106924:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010692b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010692e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106935:	ff 00 00 
80106938:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
8010693f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X | STA_R, 0, 0xffffffff, DPL_USER);
80106942:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106949:	ff 00 00 
8010694c:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106953:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106956:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
8010695d:	ff 00 00 
80106960:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106967:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010696a:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106999:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pde = &pgdir[PDX(va)];
8010699c:	8b 55 08             	mov    0x8(%ebp),%edx
8010699f:	89 fe                	mov    %edi,%esi
801069a1:	c1 ee 16             	shr    $0x16,%esi
801069a4:	8d 34 b2             	lea    (%edx,%esi,4),%esi
  if (*pde & PTE_P)
801069a7:	8b 1e                	mov    (%esi),%ebx
801069a9:	f6 c3 01             	test   $0x1,%bl
801069ac:	74 22                	je     801069d0 <walkpgdir+0x40>
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
801069ae:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801069b4:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  return &pgtab[PTX(va)];
801069ba:	89 f8                	mov    %edi,%eax
}
801069bc:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
801069bf:	c1 e8 0a             	shr    $0xa,%eax
801069c2:	25 fc 0f 00 00       	and    $0xffc,%eax
801069c7:	01 d8                	add    %ebx,%eax
}
801069c9:	5b                   	pop    %ebx
801069ca:	5e                   	pop    %esi
801069cb:	5f                   	pop    %edi
...
801069d0:	8b 45 10             	mov    0x10(%ebp),%eax
801069d3:	85 c0                	test   %eax,%eax
801069d5:	74 31                	je     80106a08 <walkpgdir+0x78>
801069d7:	e8 a4 bc ff ff       	call   80102680 <kalloc>
801069dc:	89 c3                	mov    %eax,%ebx
801069de:	85 c0                	test   %eax,%eax
801069e0:	74 26                	je     80106a08 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
801069e2:	83 ec 04             	sub    $0x4,%esp
801069e5:	68 00 10 00 00       	push   $0x1000
801069ea:	6a 00                	push   $0x0
801069ec:	50                   	push   %eax
801069ed:	e8 6e dc ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801069f2:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801069f8:	83 c4 10             	add    $0x10,%esp
801069fb:	83 c8 07             	or     $0x7,%eax
801069fe:	89 06                	mov    %eax,(%esi)
80106a00:	eb b8                	jmp    801069ba <walkpgdir+0x2a>
80106a02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
}
80106a08:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return 0;
...
80106a2c:	8b 55 10             	mov    0x10(%ebp),%edx
  a = (char *)PGROUNDDOWN((uint)va);
80106a2f:	89 c3                	mov    %eax,%ebx
  last = (char *)PGROUNDDOWN(((uint)va) + size - 1);
80106a31:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
80106a35:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char *)PGROUNDDOWN((uint)va);
80106a3a:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char *)PGROUNDDOWN(((uint)va) + size - 1);
80106a40:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a43:	8b 45 14             	mov    0x14(%ebp),%eax
80106a46:	29 d8                	sub    %ebx,%eax
80106a48:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a4b:	eb 3a                	jmp    80106a87 <mappages+0x67>
...
80106afd:	68 d0 7e 10 80       	push   $0x80107ed0
...
80106b10:	a1 c4 54 11 80       	mov    0x801154c4,%eax
...
80106c7d:	e8 9e fd ff ff       	call   80106a20 <mappages>
  memmove(mem, init, sz);
80106c82:	89 75 10             	mov    %esi,0x10(%ebp)
80106c85:	83 c4 20             	add    $0x20,%esp
80106c88:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106c94:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c95:	e9 66 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c9a:	83 ec 0c             	sub    $0xc,%esp
80106c9d:	68 15 7f 10 80       	push   $0x80107f15
...
80106d00:	68 2f 7f 10 80       	push   $0x80107f2f
...
80106d88:	68 d0 7f 10 80       	push   $0x80107fd0
...
80106dae:	0f 88 bc 00 00 00    	js     80106e70 <allocuvm+0xd0>
  if (newsz < oldsz)
80106db4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106db7:	0f 82 a3 00 00 00    	jb     80106e60 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106dbd:	8b 45 0c             	mov    0xc(%ebp),%eax
80106dc0:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106dc6:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for (; a < newsz; a += PGSIZE)
80106dcc:	39 75 10             	cmp    %esi,0x10(%ebp)
80106dcf:	0f 86 8e 00 00 00    	jbe    80106e63 <allocuvm+0xc3>
80106dd5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106dd8:	8b 7d 08             	mov    0x8(%ebp),%edi
80106ddb:	eb 43                	jmp    80106e20 <allocuvm+0x80>
...
80106df6:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106dfd:	50                   	push   %eax
80106dfe:	68 00 10 00 00       	push   $0x1000
80106e03:	56                   	push   %esi
80106e04:	57                   	push   %edi
80106e05:	e8 16 fc ff ff       	call   80106a20 <mappages>
80106e0a:	83 c4 20             	add    $0x20,%esp
80106e0d:	85 c0                	test   %eax,%eax
80106e0f:	78 6f                	js     80106e80 <allocuvm+0xe0>
  for (; a < newsz; a += PGSIZE)
80106e11:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e17:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e1a:	0f 86 a0 00 00 00    	jbe    80106ec0 <allocuvm+0x120>
    mem = kalloc();
80106e20:	e8 5b b8 ff ff       	call   80102680 <kalloc>
80106e25:	89 c3                	mov    %eax,%ebx
    if (mem == 0)
80106e27:	85 c0                	test   %eax,%eax
80106e29:	75 b5                	jne    80106de0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106e2b:	83 ec 0c             	sub    $0xc,%esp
80106e2e:	68 4d 7f 10 80       	push   $0x80107f4d
80106e33:	e8 68 98 ff ff       	call   801006a0 <cprintf>
  if (newsz >= oldsz)
80106e38:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e3b:	83 c4 10             	add    $0x10,%esp
80106e3e:	39 45 10             	cmp    %eax,0x10(%ebp)
80106e41:	74 2d                	je     80106e70 <allocuvm+0xd0>
80106e43:	8b 55 10             	mov    0x10(%ebp),%edx
80106e46:	89 c1                	mov    %eax,%ecx
80106e48:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106e4b:	31 ff                	xor    %edi,%edi
80106e4d:	e8 fe f9 ff ff       	call   80106850 <deallocuvm.part.0>
}
...
80106e5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
80106e60:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
...
80106eab:	e8 10 b6 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106ee0:	5d                   	pop    %ebp
80106ee1:	e9 6a f9 ff ff       	jmp    80106850 <deallocuvm.part.0>
...
80106f1b:	e8 30 f9 ff ff       	call   80106850 <deallocuvm.part.0>
...
80106f6c:	68 81 7f 10 80       	push   $0x80107f81
...
80106f93:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
...
80106fab:	8b 53 08             	mov    0x8(%ebx),%edx
80106fae:	83 ec 0c             	sub    $0xc,%esp
80106fb1:	ff 73 0c             	push   0xc(%ebx)
80106fb4:	29 c2                	sub    %eax,%edx
80106fb6:	50                   	push   %eax
80106fb7:	52                   	push   %edx
80106fb8:	ff 33                	push   (%ebx)
80106fba:	56                   	push   %esi
80106fbb:	e8 60 fa ff ff       	call   80106a20 <mappages>
80106fc0:	83 c4 20             	add    $0x20,%esp
80106fc3:	85 c0                	test   %eax,%eax
80106fc5:	78 19                	js     80106fe0 <setupkvm+0x60>
  for (k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106fc7:	83 c3 10             	add    $0x10,%ebx
80106fca:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
...
8010700b:	a3 c4 54 11 80       	mov    %eax,0x801154c4
  lcr3(V2P(kpgdir)); // switch to the kernel page table
...
8010703c:	68 92 7f 10 80       	push   $0x80107f92
...
80107083:	0f 84 c0 00 00 00    	je     80107149 <copyuvm+0xd9>
    return 0;
  for (i = 0; i < sz; i += PGSIZE)
80107089:	8b 55 0c             	mov    0xc(%ebp),%edx
8010708c:	85 d2                	test   %edx,%edx
8010708e:	0f 84 b5 00 00 00    	je     80107149 <copyuvm+0xd9>
...
801070b2:	68 9c 7f 10 80       	push   $0x80107f9c
...
801070d9:	74 d4                	je     801070af <copyuvm+0x3f>
    if (!(*pte & PTE_P))
801070db:	8b 38                	mov    (%eax),%edi
801070dd:	f7 c7 01 00 00 00    	test   $0x1,%edi
801070e3:	0f 84 9b 00 00 00    	je     80107184 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801070e9:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
801070eb:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
801070f1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801070f4:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if ((mem = kalloc()) == 0)
801070fa:	e8 81 b5 ff ff       	call   80102680 <kalloc>
801070ff:	89 c7                	mov    %eax,%edi
80107101:	85 c0                	test   %eax,%eax
80107103:	74 5f                	je     80107164 <copyuvm+0xf4>
      goto bad;
    memmove(mem, (char *)P2V(pa), PGSIZE);
80107105:	83 ec 04             	sub    $0x4,%esp
80107108:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
8010710e:	68 00 10 00 00       	push   $0x1000
80107113:	53                   	push   %ebx
80107114:	50                   	push   %eax
80107115:	e8 e6 d5 ff ff       	call   80104700 <memmove>
    if (mappages(d, (void *)i, PGSIZE, V2P(mem), flags) < 0)
8010711a:	58                   	pop    %eax
8010711b:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80107121:	ff 75 e4             	push   -0x1c(%ebp)
80107124:	50                   	push   %eax
80107125:	68 00 10 00 00       	push   $0x1000
8010712a:	56                   	push   %esi
8010712b:	ff 75 e0             	push   -0x20(%ebp)
8010712e:	e8 ed f8 ff ff       	call   80106a20 <mappages>
80107133:	83 c4 20             	add    $0x20,%esp
80107136:	85 c0                	test   %eax,%eax
80107138:	78 1e                	js     80107158 <copyuvm+0xe8>
  for (i = 0; i < sz; i += PGSIZE)
8010713a:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107140:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107143:	0f 87 57 ff ff ff    	ja     801070a0 <copyuvm+0x30>
  return d;
...
80107187:	68 b6 7f 10 80       	push   $0x80107fb6
...
801071b4:	0f 84 3d 04 00 00    	je     801075f7 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
8010726d:	0f 84 8b 03 00 00    	je     801075fe <copyout.cold>
  return &pgtab[PTX(va)];
...
void *find_space(struct proc *p, uint length)
{
...
801072c6:	83 ec 04             	sub    $0x4,%esp
  ...
  // Ensure length is page-aligned and the process's size is rounded up to a page boundary.
  length = PGROUNDUP(length);
801072c9:	8b 45 0c             	mov    0xc(%ebp),%eax
801072cc:	8d 88 ff 0f 00 00    	lea    0xfff(%eax),%ecx
  start_addr = PGROUNDUP(p->sz);
...
801072db:	8b 00                	mov    (%eax),%eax
  ...
  // Start searching from the next page after the end of the current process size.
  for (addr = start_addr; addr + length < KERNBASE; addr += PGSIZE)
801072dd:	89 ce                	mov    %ecx,%esi
  start_addr = PGROUNDUP(p->sz);
801072df:	89 45 f0             	mov    %eax,-0x10(%ebp)
801072e2:	05 ff 0f 00 00       	add    $0xfff,%eax
801072e7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  for (addr = start_addr; addr + length < KERNBASE; addr += PGSIZE)
801072ec:	01 c6                	add    %eax,%esi
801072ee:	0f 88 a4 00 00 00    	js     80107398 <find_space+0xd8>
  {
    // Check if a page table entry exists for this address.
    pte = walkpgdir(p->pgdir, (void *)addr, 0);
801072f4:	8b 7d 08             	mov    0x8(%ebp),%edi
  start_addr = PGROUNDUP(p->sz);
801072f7:	89 45 f0             	mov    %eax,-0x10(%ebp)
    pte = walkpgdir(p->pgdir, (void *)addr, 0);
801072fa:	8b 7f 04             	mov    0x4(%edi),%edi
801072fd:	eb 0c                	jmp    8010730b <find_space+0x4b>
801072ff:	90                   	nop
  for (addr = start_addr; addr + length < KERNBASE; addr += PGSIZE)
80107300:	05 00 10 00 00       	add    $0x1000,%eax
80107305:	89 ce                	mov    %ecx,%esi
80107307:	01 c6                	add    %eax,%esi
80107309:	78 45                	js     80107350 <find_space+0x90>
  pde = &pgdir[PDX(va)];
8010730b:	89 c2                	mov    %eax,%edx
8010730d:	c1 ea 16             	shr    $0x16,%edx
  if (*pde & PTE_P)
80107310:	8b 14 97             	mov    (%edi,%edx,4),%edx
80107313:	f6 c2 01             	test   $0x1,%dl
80107316:	74 e8                	je     80107300 <find_space+0x40>
  return &pgtab[PTX(va)];
80107318:	89 c3                	mov    %eax,%ebx
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
8010731a:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107320:	c1 eb 0a             	shr    $0xa,%ebx
80107323:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
80107329:	8d 94 1a 00 00 00 80 	lea    -0x80000000(%edx,%ebx,1),%edx
    if (pte && (*pte & PTE_P))
80107330:	85 d2                	test   %edx,%edx
80107332:	74 cc                	je     80107300 <find_space+0x40>
80107334:	f6 02 01             	testb  $0x1,(%edx)
80107337:	74 c7                	je     80107300 <find_space+0x40>
    {
      // If the page is present, this part of the address space is already in use.
      // Skip ahead to the next region after the current one.
      start_addr = PGROUNDUP(addr + length);
80107339:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
8010733f:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80107345:	89 75 f0             	mov    %esi,-0x10(%ebp)
80107348:	89 f0                	mov    %esi,%eax
  for (addr = start_addr; addr + length < KERNBASE; addr += PGSIZE)
8010734a:	89 ce                	mov    %ecx,%esi
8010734c:	01 c6                	add    %eax,%esi
8010734e:	79 bb                	jns    8010730b <find_space+0x4b>
      return (void *)start_addr;
    }
  }

  // If no suitable space is found, return 0 (equivalent to NULL in xv6).
  return (void *)0;
80107350:	31 c0                	xor    %eax,%eax
  if (addr + length <= KERNBASE)
80107352:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
80107358:	74 0e                	je     80107368 <find_space+0xa8>
}
8010735a:	83 c4 04             	add    $0x4,%esp
8010735d:	5b                   	pop    %ebx
8010735e:	5e                   	pop    %esi
8010735f:	5f                   	pop    %edi
80107360:	5d                   	pop    %ebp
...
80107362:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if (*pde & PTE_P)
80107368:	8b 7d 08             	mov    0x8(%ebp),%edi
8010736b:	8b 57 04             	mov    0x4(%edi),%edx
8010736e:	8b 92 fc 07 00 00    	mov    0x7fc(%edx),%edx
80107374:	f6 c2 01             	test   $0x1,%dl
80107377:	74 0f                	je     80107388 <find_space+0xc8>
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
80107379:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
    if (!(pte && (*pte & PTE_P)))
8010737f:	f6 82 fc 0f 00 80 01 	testb  $0x1,-0x7ffff004(%edx)
80107386:	75 d2                	jne    8010735a <find_space+0x9a>
      return (void *)start_addr;
80107388:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
8010738b:	83 c4 04             	add    $0x4,%esp
8010738e:	5b                   	pop    %ebx
8010738f:	5e                   	pop    %esi
80107390:	5f                   	pop    %edi
80107391:	5d                   	pop    %ebp
...
8010739b:	eb b3                	jmp    80107350 <find_space+0x90>
8010739d:	8d 76 00             	lea    0x0(%esi),%esi

801073a0 <is_addr_valid>:

// Checks if the address range from addr to addr+length is free and valid.
int is_addr_valid(struct proc *curproc, void *addr, int length)
{
...
801073aa:	89 c1                	mov    %eax,%ecx
  ...
  // Check if the address range falls within the user space.
  if (start >= KERNBASE || end >= KERNBASE || start + length >= KERNBASE)
801073ac:	89 c3                	mov    %eax,%ebx
801073ae:	03 4d 10             	add    0x10(%ebp),%ecx
801073b1:	0f 92 c2             	setb   %dl
801073b4:	c1 eb 1f             	shr    $0x1f,%ebx
    return 0; // Invalid range

  // Check for overflow.
  if (start > end)
801073b7:	08 da                	or     %bl,%dl
801073b9:	75 55                	jne    80107410 <is_addr_valid+0x70>
801073bb:	85 c9                	test   %ecx,%ecx
801073bd:	78 51                	js     80107410 <is_addr_valid+0x70>
    return 0; // Invalid range
...
801073bf:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  ...
  // Walk the page table entries for the address range.
  for (; start < end; start += PGSIZE)
801073c4:	39 c1                	cmp    %eax,%ecx
801073c6:	76 3f                	jbe    80107407 <is_addr_valid+0x67>
  pde_t *pgdir = curproc->pgdir;
801073c8:	8b 55 08             	mov    0x8(%ebp),%edx
801073cb:	8b 5a 04             	mov    0x4(%edx),%ebx
801073ce:	66 90                	xchg   %ax,%ax
  pde = &pgdir[PDX(va)];
801073d0:	89 c2                	mov    %eax,%edx
801073d2:	c1 ea 16             	shr    $0x16,%edx
  if (*pde & PTE_P)
801073d5:	8b 14 93             	mov    (%ebx,%edx,4),%edx
801073d8:	f6 c2 01             	test   $0x1,%dl
801073db:	74 21                	je     801073fe <is_addr_valid+0x5e>
  return &pgtab[PTX(va)];
801073dd:	89 c6                	mov    %eax,%esi
    pgtab = (pte_t *)P2V(PTE_ADDR(*pde));
801073df:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
801073e5:	c1 ee 0a             	shr    $0xa,%esi
801073e8:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
801073ee:	8d 94 32 00 00 00 80 	lea    -0x80000000(%edx,%esi,1),%edx
  {
    pte = walkpgdir(pgdir, (char *)start, 0);
    if (pte && (*pte & PTE_P))
801073f5:	85 d2                	test   %edx,%edx
801073f7:	74 05                	je     801073fe <is_addr_valid+0x5e>
801073f9:	f6 02 01             	testb  $0x1,(%edx)
801073fc:	75 12                	jne    80107410 <is_addr_valid+0x70>
  for (; start < end; start += PGSIZE)
801073fe:	05 00 10 00 00       	add    $0x1000,%eax
80107403:	39 c1                	cmp    %eax,%ecx
80107405:	77 c9                	ja     801073d0 <is_addr_valid+0x30>
      return 0; // This page is already mapped, so the range is not valid.
  }

  return 1; // The address range is free and valid.
}
80107407:	5b                   	pop    %ebx
  return 1; // The address range is free and valid.
80107408:	b8 01 00 00 00       	mov    $0x1,%eax
}
8010740d:	5e                   	pop    %esi
8010740e:	5d                   	pop    %ebp
8010740f:	c3                   	ret    
...
80107429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct proc *curproc = myproc();
8010742c:	e8 3f c5 ff ff       	call   80103970 <myproc>
  uint a;

  if (length <= 0 || (offset % PGSIZE) != 0) {
80107431:	85 db                	test   %ebx,%ebx
80107433:	7e 63                	jle    80107498 <mmap+0x78>
80107435:	f7 45 1c ff 0f 00 00 	testl  $0xfff,0x1c(%ebp)
8010743c:	75 5a                	jne    80107498 <mmap+0x78>
    cprintf("mmap failed: length <= 0 or offset not page aligned\n");
    return (void *)-1;
  }

  length = PGROUNDUP(length);
8010743e:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
80107444:	89 c6                	mov    %eax,%esi
80107446:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx

  if ((flags & MAP_FIXED) && !is_addr_valid(curproc, addr, length)) {
8010744c:	f6 45 14 08          	testb  $0x8,0x14(%ebp)
80107450:	75 6e                	jne    801074c0 <mmap+0xa0>
    cprintf("mmap failed: fixed address is invalid or already in use\n");
    return (void *)-1;
  }
...
80107457:	0f 84 eb 00 00 00    	je     80107548 <mmap+0x128>
      return (void *)-1;
    }
  }

  a = (uint)addr;
  if(allocuvm(curproc->pgdir, a, a + length) == 0) {
8010745d:	8b 55 08             	mov    0x8(%ebp),%edx
80107460:	83 ec 04             	sub    $0x4,%esp
80107463:	01 da                	add    %ebx,%edx
80107465:	52                   	push   %edx
80107466:	ff 75 08             	push   0x8(%ebp)
80107469:	ff 76 04             	push   0x4(%esi)
8010746c:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010746f:	e8 2c f9 ff ff       	call   80106da0 <allocuvm>
80107474:	83 c4 10             	add    $0x10,%esp
80107477:	85 c0                	test   %eax,%eax
80107479:	0f 84 91 00 00 00    	je     80107510 <mmap+0xf0>
  ...
  return addr;
8010747f:	8b 7d 08             	mov    0x8(%ebp),%edi
  if (flags & MAP_ANONYMOUS) {
80107482:	f6 45 14 04          	testb  $0x4,0x14(%ebp)
80107486:	75 68                	jne    801074f0 <mmap+0xd0>
}
...
80107498:	83 ec 0c             	sub    $0xc,%esp
    return (void *)-1;
8010749b:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    cprintf("mmap failed: length <= 0 or offset not page aligned\n");
801074a0:	68 f4 7f 10 80       	push   $0x80107ff4
801074a5:	e8 f6 91 ff ff       	call   801006a0 <cprintf>
    return (void *)-1;
801074aa:	83 c4 10             	add    $0x10,%esp
}
801074ad:	8d 65 f4             	lea    -0xc(%ebp),%esp
801074b0:	89 f8                	mov    %edi,%eax
801074b2:	5b                   	pop    %ebx
801074b3:	5e                   	pop    %esi
801074b4:	5f                   	pop    %edi
801074b5:	5d                   	pop    %ebp
...
801074c4:	ff 75 08             	push   0x8(%ebp)
801074c7:	50                   	push   %eax
801074c8:	e8 d3 fe ff ff       	call   801073a0 <is_addr_valid>
801074cd:	83 c4 10             	add    $0x10,%esp
801074d0:	85 c0                	test   %eax,%eax
801074d2:	75 89                	jne    8010745d <mmap+0x3d>
    cprintf("mmap failed: fixed address is invalid or already in use\n");
801074d4:	83 ec 0c             	sub    $0xc,%esp
    return (void *)-1;
801074d7:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    cprintf("mmap failed: fixed address is invalid or already in use\n");
801074dc:	68 2c 80 10 80       	push   $0x8010802c
801074e1:	e8 ba 91 ff ff       	call   801006a0 <cprintf>
    return (void *)-1;
801074e6:	83 c4 10             	add    $0x10,%esp
801074e9:	eb 9d                	jmp    80107488 <mmap+0x68>
...
801074f6:	57                   	push   %edi
801074f7:	e8 64 d1 ff ff       	call   80104660 <memset>
...
80107509:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    cprintf("mmap failed: allocuvm failed to allocate memory\n");
80107510:	83 ec 0c             	sub    $0xc,%esp
    return (void *)-1;
80107513:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    cprintf("mmap failed: allocuvm failed to allocate memory\n");
80107518:	68 94 80 10 80       	push   $0x80108094
8010751d:	e8 7e 91 ff ff       	call   801006a0 <cprintf>
  if (newsz >= oldsz)
80107522:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107525:	83 c4 10             	add    $0x10,%esp
80107528:	3b 55 08             	cmp    0x8(%ebp),%edx
8010752b:	0f 86 57 ff ff ff    	jbe    80107488 <mmap+0x68>
80107531:	8b 46 04             	mov    0x4(%esi),%eax
80107534:	8b 4d 08             	mov    0x8(%ebp),%ecx
80107537:	e8 14 f3 ff ff       	call   80106850 <deallocuvm.part.0>
8010753c:	e9 47 ff ff ff       	jmp    80107488 <mmap+0x68>
80107541:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    addr = find_space(curproc, length);
80107548:	83 ec 08             	sub    $0x8,%esp
8010754b:	53                   	push   %ebx
8010754c:	56                   	push   %esi
8010754d:	e8 6e fd ff ff       	call   801072c0 <find_space>
80107552:	83 c4 10             	add    $0x10,%esp
80107555:	89 45 08             	mov    %eax,0x8(%ebp)
    if (addr == 0) {
80107558:	85 c0                	test   %eax,%eax
8010755a:	0f 85 fd fe ff ff    	jne    8010745d <mmap+0x3d>
      cprintf("mmap failed: could not find suitable space\n");
80107560:	83 ec 0c             	sub    $0xc,%esp
      return (void *)-1;
80107563:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      cprintf("mmap failed: could not find suitable space\n");
80107568:	68 68 80 10 80       	push   $0x80108068
8010756d:	e8 2e 91 ff ff       	call   801006a0 <cprintf>
      return (void *)-1;
80107572:	83 c4 10             	add    $0x10,%esp
80107575:	e9 0e ff ff ff       	jmp    80107488 <mmap+0x68>
...
8010758c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010758f:	e8 dc c3 ff ff       	call   80103970 <myproc>

  // Length must be positive and addr must be page-aligned.
  if(length <= 0 || ((uint)addr % PGSIZE) != 0) {
80107594:	85 f6                	test   %esi,%esi
80107596:	7e 58                	jle    801075f0 <munmap+0x70>
80107598:	f7 c3 ff 0f 00 00    	test   $0xfff,%ebx
8010759e:	75 50                	jne    801075f0 <munmap+0x70>
    return -1;
  }

  // Round up the length to a page boundary.
  length = PGROUNDUP(length);
801075a0:	81 c6 ff 0f 00 00    	add    $0xfff,%esi

  // Starting address must be in user space and not overlap kernel space.
  if((uint)addr >= KERNBASE) {
801075a6:	89 da                	mov    %ebx,%edx
  length = PGROUNDUP(length);
801075a8:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  if((uint)addr >= KERNBASE) {
801075ae:	85 db                	test   %ebx,%ebx
801075b0:	78 3e                	js     801075f0 <munmap+0x70>
801075b2:	89 f1                	mov    %esi,%ecx
801075b4:	89 c7                	mov    %eax,%edi
    return -1;
  }

  // Ensure that the range does not extend beyond the user space.
  if((uint)addr + length > KERNBASE) {
801075b6:	31 c0                	xor    %eax,%eax
801075b8:	01 d9                	add    %ebx,%ecx
801075ba:	0f 92 c0             	setb   %al
801075bd:	81 f9 00 00 00 80    	cmp    $0x80000000,%ecx
801075c3:	77 2b                	ja     801075f0 <munmap+0x70>
  if (newsz >= oldsz)
801075c5:	85 c0                	test   %eax,%eax
801075c7:	74 0a                	je     801075d3 <munmap+0x53>
801075c9:	8b 47 04             	mov    0x4(%edi),%eax
801075cc:	e8 7f f2 ff ff       	call   80106850 <deallocuvm.part.0>
801075d1:	89 c2                	mov    %eax,%edx
    return -1;
  }

  // Deallocate the memory range
  if(deallocuvm(curproc->pgdir, (uint)addr, (uint)addr + length) == 0) {
801075d3:	85 d2                	test   %edx,%edx
801075d5:	74 19                	je     801075f0 <munmap+0x70>
    return -1; // deallocuvm failed
  }

  switchuvm(curproc); // Refresh the process's memory space
801075d7:	83 ec 0c             	sub    $0xc,%esp
801075da:	57                   	push   %edi
801075db:	e8 40 f5 ff ff       	call   80106b20 <switchuvm>
  return 0; // munmap succeeded
801075e0:	83 c4 10             	add    $0x10,%esp
801075e3:	31 c0                	xor    %eax,%eax
}
801075e5:	8d 65 f4             	lea    -0xc(%ebp),%esp
801075e8:	5b                   	pop    %ebx
801075e9:	5e                   	pop    %esi
801075ea:	5f                   	pop    %edi
801075eb:	5d                   	pop    %ebp
...
801075f5:	eb ee                	jmp    801075e5 <munmap+0x65>

801075f7 <uva2ka.cold>:
  if ((*pte & PTE_P) == 0)
801075f7:	a1 00 00 00 00       	mov    0x0,%eax
801075fc:	0f 0b                	ud2    

801075fe <copyout.cold>:
801075fe:	a1 00 00 00 00       	mov    0x0,%eax
80107603:	0f 0b                	ud2    
