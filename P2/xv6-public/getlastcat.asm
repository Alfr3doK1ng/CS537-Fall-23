...
main(void)
{
  ...
  if(getlastcat(buf) < 0) {
   f:	8d 5d b8             	lea    -0x48(%ebp),%ebx
{
  12:	83 ec 4c             	sub    $0x4c,%esp
  if(getlastcat(buf) < 0) {
  15:	53                   	push   %ebx
  16:	e8 28 03 00 00       	call   343 <getlastcat>
  1b:	83 c4 10             	add    $0x10,%esp
  1e:	85 c0                	test   %eax,%eax
  20:	78 13                	js     35 <main+0x35>
  ...
  35:	52                   	push   %edx
  36:	52                   	push   %edx
  37:	68 28 07 00 00       	push   $0x728
  3c:	6a 01                	push   $0x1
  3e:	e8 bd 03 00 00       	call   400 <printf>
    exit();
  43:	e8 5b 02 00 00       	call   2a3 <exit>
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
 ...
 35c:	89 d1                	mov    %edx,%ecx
{
 ...
 389:	0f b6 92 c8 07 00 00 	movzbl 0x7c8(%edx),%edx
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 70 07 00 00 	jmp    *0x770(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 66 07 00 00       	mov    $0x766,%edx
        while(*s != 0){
 ...
 5a1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 74 0a 00 00    	mov    %edx,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 78 0a 00 00       	mov    $0xa78,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 712:	00 00 00 
    if(p->s.size >= nunits){
